...
def generate_script(language: str = "ar") -> dict:
    ...
    if is_finale or sid is None:
        ...
        story_prompt = (
            "اكتب قصة قصيرة بالعربية عن هذا الموضوع بالضبط - لا تكتب عن شيء آخر:\n"
            f"{topic}\n"
            f"الحلقة {eps_in_season} من {eps_total} - {season_name}\n\n"
            "التعليمات:\n"
            "- ابدأ بأول 3 ثوانٍ أقوى جملة تلفت الانتباه. ممنوع 'كان يا ما كان'\n"
            "- المدة: " + word_target + "\n"
            "- أسلوب قصصي مشوق وسريع\n"
            "- دقة تاريخية كاملة\n"
            "- الخاتمة: سؤال عن القصة (مثلاً: 'هل كنت تعرف هذا من قبل؟')\n"
            "- اترك فضولاً للجزء القادم\n\n"
            "تنسيق الخرج بالضبط:\n"
            "##TITLE## (عنوان جذاب 40-60 حرف عن هذا الموضوع فقط)\n"
            "[نص القصة]\n"
            "##KEYWORDS## كلمة1, كلمة2, كلمة3, كلمة4, كلمة5, كلمة6, كلمة7, كلمة8\n\n"
            "اكتب فقط القصة عن الموضوع المذكور أعلاه."
        )
        data = {
            "season_id": sid,
