...
def generate_script(language: str = "ar") -> dict:
    ...
    if is_finale or sid is None:
        ...
        story_prompt = (
            ...
            "السطر الأول بالضبط - عنوان جذاب وملفت يرتبط مباشرة بالقصة:\n"
            "##TITLE## عنوان (40-60 حرفاً) يصف القصة بدقة ويستخدم كلمة قوية مثل: سر، معجزة، الحقيقة الصادمة، كيف، لا تصدق، أبكى، صدمة، أغرب، لن تتخيل. يجب أن يكون خاصاً بهذه القصة وليس عاماً.\n"
            "مثال: إذا كانت القصة عن عثمان بن عفان وتجهيز جيش العسرة:\n"
            "##TITLE## سر الثراء الذي جعل عثمان بن عفان يجهز جيشاً كاملاً بمفرده\n"
            "مثال: إذا كانت القصة عن سيدنا نوح:\n"
            "##TITLE## الحقيقة الصادمة عن قصة سفينة نوح التي لا يعرفها الكثيرون\n\n"
