...
HASHTAGS = [
    "#اسلام", "#اللهم", "#قرآن", "#دين",
    "#اسلاميات", "#قصص_الأنبياء", "#قصص_الصحابة", "#السيرة_النبوية",
    "#الصحابة", "#الأنبياء", "#الإسلام", "#ذكر",
    "#دعاء", "#هداية", "#إيمان", "#شورتس",
    "#islam", "#islamic", "#quran", "#allah",
    "#muslim", "#prophet", "#IslamicReminder", "#قصص_إسلامية",
    "#عبر", "#موعظة", "#التوحيد", "#الجنة",
]
...
VIRAL_TAGS = [
    "اسلام", "اللهم", "قرآن", "دين",
    "اسلاميات", "قصص الانبياء", "قصص الصحابة", "السيرة النبوية",
    "الصحابة", "الانبياء", "الاسلام", "ذكر",
    "دعاء", "هداية", "ايمان", "islamic",
    "quran", "allah", "muslim", "prophet stories",
    "islamic reminder", "قصص إسلامية", "عبر", "موعظة",
    "التوحيد", "الجنة", "سبحان الله", "الحمد لله",
    "islamic shorts", "viral islam",
]
...
def upload_video(script_data: dict) -> str:
    ...
    desc_parts = [
        ...
        "",
        "\u2014\u2014\u2014",
        "#\u0625\u0631\u062b_\u0627\u0644\u0625\u064a\u0645\u0627\u0646 #\u0627\u0633\u0644\u0627\u0645 #\u0627\u0644\u0644\u0647\u0645 #\u0642\u0631\u0622\u0646 #\u062f\u064a\u0646 #\u0627\u0633\u0644\u0627\u0645\u064a\u0627\u062a #\u0642\u0635\u0635_\u0627\u0644\u0623\u0646\u0628\u064a\u0627\u0621 #\u0642\u0635\u0635_\u0627\u0644\u0635\u062d\u0627\u0628\u0629 #\u0627\u0644\u0633\u064a\u0631\u0629_\u0627\u0644\u0646\u0628\u0648\u064a\u0629 #\u0627\u0644\u0635\u062d\u0627\u0628\u0629 #\u0627\u0644\u0623\u0646\u0628\u064a\u0627\u0621 #\u0630\u0643\u0631 #\u062f\u0639\u0627\u0621 #\u0647\u062f\u0627\u064a\u0629 #\u0625\u064a\u0645\u0627\u0646 #shorts #islam #islamic #quran #allah #muslim #prophet #IslamicReminder #\u0642\u0635\u0635_\u0625\u0633\u0644\u0627\u0645\u064a\u0629 #\u0639\u0628\u0631 #\u0645\u0648\u0639\u0638\u0629 #\u0627\u0644\u062a\u0648\u062d\u064a\u062f #\u0627\u0644\u062c\u0646\u0629",
        "",
